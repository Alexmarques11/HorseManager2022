...
ScreenHouse vetScreen = new(topbar, HouseType.Vet, cityScreen);
ScreenHouse shopScreen = new( topbar, HouseType.Shop, cityScreen);
ScreenHouse shopBuyScreen = new(topbar, HouseType.Shop, shopScreen);
ScreenHouse shopSellScreen = new(topbar, HouseType.Shop, shopScreen);
ScreenHouse stableScreen = new(topbar, HouseType.Stable, cityScreen);
ScreenHouse raceTrackScreen = new(topbar, HouseType.Racetrack, cityScreen);
...
shopScreen.AddOption("LootBox", shopScreen, () =>
{
    ...
    DialogConfirmation dialogConfirmation = new(
        ...
        onConfirm: () => {
            ...
            {
                message = Utils.AlignLeft("You don't have enough money to buy a lootbox.", 36);
